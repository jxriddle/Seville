...
namespace seville
{
    namespace palace
    {
        ...
        public:
            ...
            // static const QString kIdent = "PC4237" // PC5006 for js client
            ...
            inline Host::ByteOrder byteOrderKind(void) {
                return my_byteOrder;
            }

            inline void setByteOrderKind(const Host::ByteOrder value) {
                my_byteOrder = value;
            }
        ...
        private:
            ...
            Host::ByteOrder do_clientByteOrder(void);
            Host::ByteOrder do_serverByteOrder(void);
            bool do_determineIsConnected(void) const;
            NetMsgOptions do_shouldSwapEndianness(void) const;
